...
export default function ContactUs() {
  ...
  return (
    <div className="flex flex-col items-center px-6 pt-12 pb-16 lg:pt-16 lg:pb-20 bg-soft-blue">
      <div className="text-center font-rubik max-w-[476px]">
        <p className="text-white text-sm tracking-widest mt-6 mb-2 lg:mb-10">35,000+ ALREADY JOINED</p>
